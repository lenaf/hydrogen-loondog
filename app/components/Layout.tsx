...
function Footer({ menu }: { menu?: EnhancedMenu }) {
  ...
  return (
    <Section
      ...
      as="footer"
      role="contentinfo"
      className={`grid min-h-[12rem] items-start grid-flow-row w-full gap-6 py-8 px-6 md:px-8 lg:px-12 md:gap-8 lg:gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-${itemsCount}
         overflow-hidden`}
    >
      ...
      >
        &copy; {new Date().getFullYear()} / Dev and designed by Lena
      </div>
    </Section>
  );
}
